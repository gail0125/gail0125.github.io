...
func convertNSTimeInterval2String(_ time:TimeInterval) -> String {      currenttime을 00:00 형태의 문자열로 변환했습니다.
 ...
 @IBAction func btnPlayAudio(_ sender: UIButton) {                 재생 버튼을 클릭 하였을때 동작코드입니다
   ...
   @objc func updatePlayTime() {                          0.1초 마다 호출되며 재생시간을 표시합니다
...
@IBAction func btnStopAudio(_ sender: UIButton) {                   멈춤 버튼을 클릭하였을때의 동작 코드입니다
